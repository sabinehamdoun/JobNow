...
const Work = () => {
  return (
    <div className="2xl:container mx-auto py-10 px-8 sm:py-28 sm:px-8 md:px-20">
      ...
      <div className="grid grid-cols-5 gap-8 md:gap-10 lg:gap-14 sm:pt-32 sm:pb-5">
        <div className="col-span-5 sm:col-span-2 rounded-3xl bg-[#c4c4c4]"></div>
        <div className="col-span-5 sm:col-span-3 flex flex-col items-start gap-6 py-7 sm:py-10 text-center sm:text-start">
          <h2 className="text-2xl sm:text-4xl mx-auto sm:mx-0 font-semibold">
