...
const Footer = () => {
  return (
    <div className="bg-[#00cc99]">
      <div className="2xl:container mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 px-6 sm:px-14 py-10 pt-52">
        <div className="text-white my-auto col-span-2 md:col-span-1">
          <h1 className="font-bold text-4xl text-black">
            Job<span className="text-white">Now</span>
          </h1>
          <p className="font-light text-xs leading-normal mt-2">
        ...
        <div className="text-white col-span-1 md:col-span-1">
          ...
          <ul className="flex flex-col gap-2 mt-2 list-none text-xs pr-12">
        ...
        <div className="text-white col-span-1 md:col-span-1 ml-auto sm:ml-0">
