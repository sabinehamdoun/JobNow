...
const Header = () => {
  return (
    <div>
      <div className="bg-[#f2f2f2] sm:bg-gradient-to-r sm:via-[#f2f2f2] sm:from-[#f2f2f2] sm:to-[#00cc99]">
        <div className="2xl:container mx-auto flex flex-col sm:flex-row">
          ...
          <div className="bg-gradient-to-r from-[#00cc99] to-[#00cc9932] via-[#00cc99] sm:rounded-bl-[50px] sm:ml-auto w-[100%] sm:w-[40%]">
